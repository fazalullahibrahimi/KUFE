...
import { MapPin, Phone, Mail, Clock, Send, ChevronRight, CheckCircle, AlertCircle } from "lucide-react"
...
function ContactPage() {
  ...
  useEffect(() => {
    const fetchDepartments = async () => {
      try {
        ...
        console.log(`Attempting to fetch departments (attempt ${retryCount + 1})`)
        ...
        if (result.status === "success" && result.data && result.data.departments) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(responseData?.message || `Failed to submit form: ${response.status} ${response.statusText}`)
      }
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#E8ECEF] to-white">
      ...
      >
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-4 text-white">Get in Touch</h1>
            <p className="mt-4 text-white/80 text-lg md:text-xl max-w-2xl leading-relaxed">
              We're here to answer your questions about the Faculty of Economics at Kandahar University. Reach out to us
              for information about programs, admissions, or general inquiries.
            </p>
                ...
                <div className="p-8 md:p-10 relative">
                  ...
                  {formSubmitted ? (
                    <div className="bg-[#E8ECEF]/50 backdrop-blur-sm border border-[#1D3D6F]/20 rounded-xl p-8 text-center animate-fade-in">
                      ...
                      <p className="text-[#1D3D6F]/70">We'll get back to you as soon as possible.</p>
                    </div>
                  ) : (
                    <form onSubmit={handleSubmit} className="space-y-8">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3 group">
                          <Label htmlFor="name" className="text-[#1D3D6F] font-medium flex items-center">
                        ...
                        <div className="space-y-3 group">
                          <Label htmlFor="email" className="text-[#1D3D6F] font-medium flex items-center">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3 group">
                          <Label htmlFor="subject" className="text-[#1D3D6F] font-medium flex items-center">
                        ...
                        <div className="space-y-3 group">
                          ...
                          {selectedDepartmentName && (
                            <p className="text-xs text-green-600 mt-1">Selected: {selectedDepartmentName}</p>
                          )}
                        </div>
                      </div>

                      <div className="space-y-3 group">
                        <Label htmlFor="message" className="text-[#1D3D6F] font-medium flex items-center">
                ...
                <div className="bg-gradient-to-br from-[#1D3D6F] to-[#2C4F85] text-white p-8 md:p-10 rounded-2xl h-full relative overflow-hidden">
                  ...
                  <div className="space-y-8 relative z-10">
                    <div className="flex items-start group">
                      ...
                      <div className="ml-4">
                        <h3 className="text-[#F7B500] font-medium mb-1">Our Location</h3>
                    ...
                    <div className="flex items-start group">
                      ...
                      <div className="ml-4">
                        <h3 className="text-[#F7B500] font-medium mb-1">Phone Number</h3>
                        <p className="text-white/90">+93 70 000 0000</p>
                        <p className="text-white/70 text-sm mt-1">Monday to Thursday, 8am to 4pm</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start group">
                      ...
                      <div className="ml-4">
                        <h3 className="text-[#F7B500] font-medium mb-1">Email Address</h3>
                        <p className="text-white/90">info@kufe.edu.af</p>
                        <p className="text-white/70 text-sm mt-1">We'll respond as soon as possible</p>
                      </div>
                    </div>
                  </div>
      ...
      <div
        ...
        className={`mt-12 container mx-auto px-4 md:px-8 mb-16 transition-all duration-700 transform 
          ${mapVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
        style={{ transitionDelay: "0.7s" }}
      >
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-[#1D3D6F] mb-4">Find Us on the Map</h2>
