...
import { Plus, Save, Upload, BookOpen, FileText } from "lucide-react"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6 flex items-center">
          <div className="w-12 h-12 rounded-full bg-[#F4B400] bg-opacity-10 flex items-center justify-center mr-4">
            <span className="text-[#F4B400] font-bold">{new Set(courses.map((course) => course.instructor)).size}</span>
          </div>
          <div>
        ...
        <div className="bg-white rounded-lg shadow p-6 flex items-center">
          <div className="w-12 h-12 rounded-full bg-green-500 bg-opacity-10 flex items-center justify-center mr-4">
            <span className="text-green-500 font-bold">
              {courses.reduce((total, course) => total + Number.parseInt(course.credits || 0), 0)}
            </span>
          </div>
          <div>
